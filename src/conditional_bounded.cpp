...
int main(void)
{
	...
	std::cout << "Time taken by conditional bounded was: " << duration.count() << " microseconds" << '\n';

	stbi_write_jpg("conditional_bounded.jpg" , width , height , bytes_per_pixel , image_data , 100);
	free(image_data);
}
